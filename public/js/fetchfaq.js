...
fetch(url)
  .then(response => response.json())
    ...
    .finally(() => {
      // On click any edit button for FAQ, show the corresponding edit field
      document.querySelectorAll('.btn-faq-edit').forEach((btn) => {
        btn.addEventListener('click', showEditFields);
      })
    })
